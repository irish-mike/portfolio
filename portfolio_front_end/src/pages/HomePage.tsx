  ...
  return (
    <>
      ...
      <AboutSection title={"About Me"}>
        ...
        <p>Holding dual US and Irish citizenship, I currently reside in Valencia, Spain, and am proficient in Spanish at a B1 level, aiming for fluency. Open to relocation for the right opportunity.</p>
      </AboutSection>
